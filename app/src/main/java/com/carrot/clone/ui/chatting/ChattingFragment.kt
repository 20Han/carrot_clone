...
class ChattingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_chatting, container, false)
        val textView: TextView = root.findViewById(R.id.text_chatting)
